#!/usr/bin/python3
"""
A Flask web application with routes including odd/even number template
...
Route: /number_odd_or_even/<n> displays HTML page with odd/even info
"""
...
def number_odd_or_even(n):
    """Return HTML template with number and odd/even info"""
